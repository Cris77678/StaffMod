...
/**
 * Estado de staff para un jugador específico.
 */
public class PlayerData {

    public UUID uuid;
    public String lastName; // último nombre conocido

    // Mute
    public boolean muted = false;
    public long muteExpiry = -1; // -1 = permanente, epoch millis si temporal
    ...
    public boolean isMuteActive() {
        ...
        if (System.currentTimeMillis() >= muteExpiry) { muted = false; return false; }
        return true;
    }
    ...
    /** Formatea tiempo restante como "1h 30m 20s" o "Permanente" */
    ...
    /** Parsea "10m", "2h", "1d", "perm" → epoch millis o -1 */
    public static long parseDuration(String input) {
        ...
        try {
            long multiplier;
            if (s.endsWith("s"))      { multiplier = 1000L;                  s = s.substring(0, s.length()-1); }
    ...
    public record WarnEntry(String reason, long timestamp, String staffName) {}
}