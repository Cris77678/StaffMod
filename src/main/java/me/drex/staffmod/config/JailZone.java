...
/**
 * Zona rectangular de una cárcel definida por dos esquinas.
 */
public class JailZone {
    ...
    // Punto de teleport al entrar a jail (centro de la zona)
    ...
    public JailZone(String name, String dimension,
        ...
        this.spawnX = (this.x1 + this.x2) / 2;
        this.spawnY = this.y1;
        this.spawnZ = (this.z1 + this.z2) / 2;
    }
    ...
    /** Clampea la posición para que quede dentro de la zona */
