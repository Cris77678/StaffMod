    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("sc")
            ...
            .executes(ctx -> {
                ...
                boolean isToggled = DataStore.isStaffChatToggled(player.getUUID());
                
                player.sendSystemMessage(Component.literal(isToggled ? 
                    "§a[StaffChat] Activado. Todos tus mensajes irán al canal de staff." : 
                    "§c[StaffChat] Desactivado. Ahora hablarás en el chat global."));
                return 1;
            })
